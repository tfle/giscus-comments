# Website Comments and Reactions
...
Website visitors need to login using their GitHub accounts to allow giscus to post on their behalf. GitHub users can also post a comment via this repository if the Discussion has already been created.
